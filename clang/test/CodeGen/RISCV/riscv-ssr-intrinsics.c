// RUN: %clang_cc1 -triple riscv32 -target-feature +xssr -emit-llvm %s -o - \
// RUN:     | FileCheck %s
...
// CHECK: call void @llvm.riscv.ssr.setup.bound.stride.2d
...
// CHECK: call void @llvm.riscv.ssr.setup.bound.stride.3d
...
// CHECK: call void @llvm.riscv.ssr.setup.bound.stride.4d
