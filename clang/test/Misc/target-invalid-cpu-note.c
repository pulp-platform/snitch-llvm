...
// TUNE-RISCV32-NEXT: note: valid target CPU values are: generic-rv32, mempool-rv32, rocket-rv32, sifive-7-rv32, sifive-e20, sifive-e21, sifive-e24, sifive-e31, sifive-e34, sifive-e76, snitch, generic, rocket, sifive-7-series{{$}}
