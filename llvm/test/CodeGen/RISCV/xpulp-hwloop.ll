...
for.cond1.preheader.us:
  ...
  %0 = load i32, i32* %arrayidx.us, align 4, !tbaa !4
...
for.body4.us:
  ...
  %1 = load i32, i32* %arrayidx5.us, align 4, !tbaa !4
  %sub.us = add i32 %0, %sum.118.us
  %add.us = sub i32 %sub.us, %1
  %inc.us = add nuw nsw i32 %ib.019.us, 1
  %exitcond.not = icmp eq i32 %inc.us, %nb
  br i1 %exitcond.not, label %for.cond1.for.cond.cleanup3_crit_edge.us, label %for.body4.us, !llvm.loop !11

for.cond1.for.cond.cleanup3_crit_edge.us:
  %inc7.us = add nuw nsw i32 %ia.022.us, 1
  %exitcond26.not = icmp eq i32 %inc7.us, %na
  br i1 %exitcond26.not, label %for.cond.cleanup, label %for.cond1.preheader.us, !llvm.loop !12
...
for.body5.us:                                     ; preds = %for.cond2.preheader.us, %for.body5.us
  ...
  %1 = load i32, i32* %arrayidx6.us, align 4, !tbaa !4
  %sub7.us = add i32 %0, %sum.121.us
  %add.us = sub i32 %sub7.us, %1
  %cmp3.us = icmp sgt i32 %ib.022.us.in, 1
  br i1 %cmp3.us, label %for.body5.us, label %for.cond2.for.cond.loopexit_crit_edge.us, !llvm.loop !13

for.cond2.for.cond.loopexit_crit_edge.us:         ; preds = %for.body5.us
  %cmp.us = icmp sgt i32 %ia.026.us.in, 1
  br i1 %cmp.us, label %for.cond2.preheader.us, label %for.cond.cleanup, !llvm.loop !14
...
for.cond1.preheader.us.us:                        ; preds = %entry, %for.cond1.for.cond.cleanup3_crit_edge.split.us.us.us
  ...
  %0 = load i32, i32* %arrayidx.us.us, align 4, !tbaa !4
...
for.cond5.preheader.us.us.us:                     ; preds = %for.cond5.for.cond.cleanup7_crit_edge.us.us.us, %for.cond1.preheader.us.us
  ...
  %1 = load i32, i32* %arrayidx9.us.us.us, align 4, !tbaa !4
...
for.body8.us.us.us:                               ; preds = %for.body8.us.us.us, %for.cond5.preheader.us.us.us
  ...
  %2 = load i32, i32* %arrayidx10.us.us.us, align 4, !tbaa !4
  ...
  br i1 %exitcond.not, label %for.cond5.for.cond.cleanup7_crit_edge.us.us.us, label %for.body8.us.us.us, !llvm.loop !15
...
for.cond5.for.cond.cleanup7_crit_edge.us.us.us:   ; preds = %for.body8.us.us.us
  ...
  br i1 %exitcond53.not, label %for.cond1.for.cond.cleanup3_crit_edge.split.us.us.us, label %for.cond5.preheader.us.us.us, !llvm.loop !16
...
for.cond1.for.cond.cleanup3_crit_edge.split.us.us.us: ; preds = %for.cond5.for.cond.cleanup7_crit_edge.us.us.us
  ...
  br i1 %exitcond54.not, label %for.cond.cleanup, label %for.cond1.preheader.us.us, !llvm.loop !17
...
for.cond7.preheader.us.us.us:                     ; preds = %for.cond7.for.cond2.loopexit_crit_edge.us.us.us, %for.cond2.preheader.us.us
  ...
  %1 = load i32, i32* %arrayidx11.us.us.us, align 4, !tbaa !4
...
for.body10.us.us.us:                              ; preds = %for.body10.us.us.us, %for.cond7.preheader.us.us.us
  ...
  %2 = load i32, i32* %arrayidx13.us.us.us, align 4, !tbaa !4
  ...
  br i1 %cmp8.us.us.us, label %for.body10.us.us.us, label %for.cond7.for.cond2.loopexit_crit_edge.us.us.us, !llvm.loop !18

for.cond7.for.cond2.loopexit_crit_edge.us.us.us:  ; preds = %for.body10.us.us.us
  %cmp3.us.us.us = icmp sgt i32 %ib.041.us.us.us.in, 1
  br i1 %cmp3.us.us.us, label %for.cond7.preheader.us.us.us, label %for.cond2.for.cond.loopexit_crit_edge.split.us.us.us, !llvm.loop !19
...
for.cond2.for.cond.loopexit_crit_edge.split.us.us.us: ; preds = %for.cond7.for.cond2.loopexit_crit_edge.us.us.us
  ...
  br i1 %cmp.us.us, label %for.cond2.preheader.us.us, label %for.cond.cleanup, !llvm.loop !20
...
attributes #0 = { nofree norecurse nosync nounwind readonly "frame-pointer"="none" "min-legal-vector-width"="0" "no-builtins" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+a,+c,+f,+m,+xpulpv" }
...
!3 = !{!"clang version 14.0.6 (git@iis-git.ee.ethz.ch:f.ficarelli/llvm-project.git 0bed40beac398b98e76c6abae2c98c872bc204b4)"}
!4 = !{!5, !5, i64 0}
!5 = !{!"int", !6, i64 0}
